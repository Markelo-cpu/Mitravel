(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            '.dd-select{color: white;  border-radius:2px; position:relative; cursor:pointer; }' +
            '.dd-desc { color:#aaa; display:block; overflow: hidden; font-weight:normal; line-height: 1.4em; }' +
            '.dd-selected{ color: white; overflow:hidden; display:block; padding:10px; font-weight:bold;}' +
            '.dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}' +
            '.dd-pointer-down{ border-top:solid 5px #000; }' +
            '.dd-pointer-up{border: transparent !important;  margin-top:-8px;}' +
            '.dd-options{  border-top:none; list-style:none;  display:none; position:absolute;  margin:0; padding:0;}' +
            '.dd-option{ margin-top: 5px;display:block;  overflow:hidden; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }' +
            ...
            '.dd-selected-text { font-weight:bold; color: white}​</style>';
    c.init = function (l) {
        var l = e.extend({}, d, l);
